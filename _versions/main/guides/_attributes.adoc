...
:mssql-image-aarch64: mcr.microsoft.com/azure-sql-edge:latest
:mysql-image: docker.io/library/mysql:9.5
:oracle-image: docker.io/gvenzl/oracle-free:23-slim-faststart
:postgres-image: docker.io/library/postgres:18
:elasticsearch-version: 9.3.2
:elasticsearch-image: docker.io/elastic/elasticsearch:9.3.2
:opensearch-image: docker.io/opensearchproject/opensearch:3.5.0
:infinispan-version: ${infinispan.version}
:infinispan-protostream-version: ${infinispan.protostream.version}
:logstash-image: docker.io/elastic/logstash:9.3.2
:kibana-image: docker.io/elastic/kibana:9.3.2
:keycloak-image: quay.io/keycloak/keycloak:26.5.4
:amqp-image: quay.io/artemiscloud/activemq-artemis-broker:1.0.25
:apicurio-registry-image: quay.io/apicurio/apicurio-registry:3.1.7
...
:hibernate-orm-version-major-minor: 7.3
:hibernate-search-version-major-minor: 8.3
