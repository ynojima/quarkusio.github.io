...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/pkg/builditem/BuildAotOptimizedContainerImageRequestBuildItem.java[`io.quarkus.deployment.pkg.builditem.BuildAotOptimizedContainerImageRequestBuildItem`, window="_blank"]
[.description]
--
A build item that represents a request to build an AOT enhanced container image
-- a|`java.lang.String originalContainerImage` 

_No Javadoc found_

`java.lang.String containerWorkingDirectory` 

_No Javadoc found_

`java.nio.file.Path aotFile` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/pkg/builditem/BuildAotOptimizedContainerImageResultBuildItem.java[`io.quarkus.deployment.pkg.builditem.BuildAotOptimizedContainerImageResultBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/pkg/builditem/BuildPgoOptimizedNativeRequestBuildItem.java[`io.quarkus.deployment.pkg.builditem.BuildPgoOptimizedNativeRequestBuildItem`, window="_blank"]
[.description]
--
A build item that represents a request to build a PGO-optimized native image
-- a|`java.nio.file.Path profilePath` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/pkg/builditem/BuildPgoOptimizedNativeResultBuildItem.java[`io.quarkus.deployment.pkg.builditem.BuildPgoOptimizedNativeResultBuildItem`, window="_blank"]
[.description]
--
A build item that represents the result of building a PGO-optimized native image
-- a|`java.nio.file.Path optimizedBinaryPath` 
...
`java.util.Set<String> highPriorityConfig` 

_No Javadoc found_

`java.util.Set<DevServiceConfigDependency<? extends Startable>> dependencies` 

_No Javadoc found_

`java.util.Set<DevServiceConfigDependency<? extends Startable>> optionalDependencies` 
...
a|icon:building[title=Non-instantiatable Build Item (can be inherited from)] https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/nativeimage/FfmCallBuildItem.java[`io.quarkus.deployment.builditem.nativeimage.FfmCallBuildItem`, window="_blank"]
[.description]
--
Used to register an upcall/downcall signature for FFI/FFM runtime access.
-- a|`java.lang.String returnType` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/nativeimage/FfmDowncallBuildItem.java[`io.quarkus.deployment.builditem.nativeimage.FfmDowncallBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/nativeimage/FfmUpcallBuildItem.java[`io.quarkus.deployment.builditem.nativeimage.FfmUpcallBuildItem`, window="_blank"]
[.description]
--
...
`java.util.Optional<List<String>> additionalJvmArgs` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/LogNamedHandlerFormatBuildItem.java[`io.quarkus.deployment.builditem.LogNamedHandlerFormatBuildItem`, window="_blank"]
[.description]
--
...
-- a|`io.quarkus.runtime.RuntimeValue<Map<NamedHandlerType,Map<String,Optional<Formatter>>>> namedFormattersValue` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/ModuleEnableNativeAccessBuildItem.java[`io.quarkus.deployment.builditem.ModuleEnableNativeAccessBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/ModuleOpenBuildItem.java[`io.quarkus.deployment.builditem.ModuleOpenBuildItem`, window="_blank"]
[.description]
--
...
-- a|`java.lang.String openedModuleName` 

_No Javadoc found_

`java.lang.String openingModuleName` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/PreInitBuildItem.java[`io.quarkus.deployment.builditem.PreInitBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/PreInitRunnableBuildItem.java[`io.quarkus.deployment.builditem.PreInitRunnableBuildItem`, window="_blank"]
[.description]
--
...
-- a|`java.lang.String runnableClassName` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/dev/RecompilationDependenciesBuildItem.java[`io.quarkus.deployment.dev.RecompilationDependenciesBuildItem`, window="_blank"]
[.description]
--
...
-- a|`java.util.Map<DotName,Set<DotName>> classToRecompilationTargets` 
...
-- a|`java.util.Collection<String> className` 
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/logging/StaticInitLoggingSetupBuildItem.java[`io.quarkus.deployment.logging.StaticInitLoggingSetupBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/core/deployment/src/main/java/io/quarkus/deployment/builditem/ValueRegistryRuntimeInfoProviderBuildItem.java[`io.quarkus.deployment.builditem.ValueRegistryRuntimeInfoProviderBuildItem`, window="_blank"]
[.description]
--
_No Javadoc found_
-- a|`java.lang.Class<? extends RuntimeInfoProvider> runtimeInfoProvider` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/cache/deployment/src/main/java/io/quarkus/cache/deployment/CacheManagerInfoBuildItem.java[`io.quarkus.cache.deployment.CacheManagerInfoBuildItem`, window="_blank"]
[.description]
--
...
`java.util.function.Function<String,Map<String,Function<DatasourceStartable,String>>> deferredConfigProviderFunction` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devui/deployment-spi/src/main/java/io/quarkus/devui/spi/welcome/DynamicWelcomeBuildItem.java[`io.quarkus.devui.spi.welcome.DynamicWelcomeBuildItem`, window="_blank"]
[.description]
--
Adds dynamic data to the welcome page
-- a|`java.lang.String html` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devservices/keycloak/src/main/java/io/quarkus/devservices/keycloak/KeycloakDevServicesPreparedBuildItem.java[`io.quarkus.devservices.keycloak.KeycloakDevServicesPreparedBuildItem`, window="_blank"]
[.description]
--
...
-- a|`java.lang.String devServiceConfigHashCode` 
...
`io.quarkus.deployment.Feature feature` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/devservices/oidc/src/main/java/io/quarkus/devservices/oidc/OidcDevServicesPreparedBuildItem.java[`io.quarkus.devservices.oidc.OidcDevServicesPreparedBuildItem`, window="_blank"]
[.description]
--
...
`java.util.Set<String> persistenceUnits` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/hibernate-orm/deployment-spi/src/main/java/io/quarkus/hibernate/orm/deployment/spi/SqlLoadScriptDefaultBuildItem.java[`io.quarkus.hibernate.orm.deployment.spi.SqlLoadScriptDefaultBuildItem`, window="_blank"]
[.description]
--
...
-- a|`java.lang.String resourceName` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/panache/hibernate-panache-next/deployment/src/main/java/io/quarkus/hibernate/panache/deployment/EntityToPersistenceUnitBuildItem.java[`io.quarkus.hibernate.panache.deployment.EntityToPersistenceUnitBuildItem`, window="_blank"]
[.description]
--
Used to record that a specific JPA entity is associated with a specific persistence unit
-- a|`java.lang.String entityClass` 
...
`java.lang.String reactivePersistenceUnitName` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/panache/hibernate-panache-next/deployment/src/main/java/io/quarkus/hibernate/panache/deployment/PanacheEntityClassBuildItem.java[`io.quarkus.hibernate.panache.deployment.PanacheEntityClassBuildItem`, window="_blank"]
[.description]
--
Represents a regular Panache entity class.
-- a|`org.jboss.jandex.ClassInfo entityClass` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/jaxb/deployment/src/main/java/io/quarkus/jaxb/deployment/IgnoreJaxbAnnotatedClassesBuildItem.java[`io.quarkus.jaxb.deployment.IgnoreJaxbAnnotatedClassesBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/mongodb-client/deployment-spi/src/main/java/io/quarkus/mongodb/deployment/spi/MongoClientBuildItem.java[`io.quarkus.mongodb.deployment.spi.MongoClientBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/mongodb-client/deployment-spi/src/main/java/io/quarkus/mongodb/deployment/spi/MongoClientsBuildItem.java[`io.quarkus.mongodb.deployment.spi.MongoClientsBuildItem`, window="_blank"]
[.description]
--
The unique list of MongoDB client names.
-- a|`java.util.List<MongoClientBuildItem> mongoClients` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/mongodb-client/deployment-spi/src/main/java/io/quarkus/mongodb/deployment/spi/MongoConnectionPoolListenerBuildItem.java[`io.quarkus.mongodb.deployment.spi.MongoConnectionPoolListenerBuildItem`, window="_blank"]
[.description]
--
Registers a new `com.mongodb.event.ConnectionPoolListener` .
-- a|`java.util.function.Function<String,ConnectionPoolListener> connectionPoolListener` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/mutiny/deployment/src/main/java/io/quarkus/mutiny/deployment/MutinyRuntimeInitBuildItem.java[`io.quarkus.mutiny.deployment.MutinyRuntimeInitBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/proxy-registry/deployment/src/main/java/io/quarkus/proxy/deployment/ProxyRegistryBuildItem.java[`io.quarkus.proxy.deployment.ProxyRegistryBuildItem`, window="_blank"]
[.description]
--
A build item that indicates that the proxy registry has been initialized.
-- a|`java.util.function.Supplier<ProxyConfigurationRegistry> registry` 
...
`io.quarkus.qute.runtime.MessageBundleRecorder.MessageInfo messageInfo` 
...
`io.quarkus.qute.ParserConfig parserConfig` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/reactive-datasource/spi/src/main/java/io/quarkus/reactive/datasource/spi/ReactiveDataSourceBuildItem.java[`io.quarkus.reactive.datasource.spi.ReactiveDataSourceBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/resteasy-reactive/rest-client/spi-deployment/src/main/java/io/quarkus/rest/client/reactive/spi/ClientRequestFilterBuildItem.java[`io.quarkus.rest.client.reactive.spi.ClientRequestFilterBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/resteasy-reactive/rest-client/spi-deployment/src/main/java/io/quarkus/rest/client/reactive/spi/ClientResponseFilterBuildItem.java[`io.quarkus.rest.client.reactive.spi.ClientResponseFilterBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/resteasy-classic/rest-client-config/deployment/src/main/java/io/quarkus/restclient/config/deployment/RestClientsBuildTimeConfigBuildItem.java[`io.quarkus.restclient.config.deployment.RestClientsBuildTimeConfigBuildItem`, window="_blank"]
[.description]
--
...
-- a|`java.util.List<RegisteredRestClient> restClients` 
...
`io.quarkus.restclient.config.RestClientsBuildTimeConfig restClientsBuildTimeConfig` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/security/spi/src/main/java/io/quarkus/security/spi/RunAsUserPredicateBuildItem.java[`io.quarkus.security.spi.RunAsUserPredicateBuildItem`, window="_blank"]
[.description]
--
...
-- a|`java.util.function.Predicate<AnnotationTarget> annotationTargetPredicate` 
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/swagger-ui/deployment/src/main/java/io/quarkus/swaggerui/deployment/SwaggerUiUrlBuildItem.java[`io.quarkus.swaggerui.deployment.SwaggerUiUrlBuildItem`, window="_blank"]
[.description]
--
...
a| https://github.com/quarkusio/quarkus/blob/main/extensions/vertx-http/deployment-spi/src/main/java/io/quarkus/vertx/http/deployment/spi/WebDependencyJarBuildItem.java[`io.quarkus.vertx.http.deployment.spi.WebDependencyJarBuildItem`, window="_blank"]
[.description]
--
