...
h|[[quarkus-core_section_quarkus-package-jar]] [.section-name.section-level0]##link:#quarkus-core_section_quarkus-package-jar[Building a jar]##
h|Type
h|Default
...
--
a|tooltip:fast-jar[The "fast JAR" packaging type.], tooltip:aot-jar[The AOT-optimized packaging type.  Similar to fast-jar in the approach but taking into account the limitations of AOT class loading (i.e. all class loading delegated to JDK class loader).], tooltip:uber-jar[The "Uber-JAR" packaging type.], tooltip:mutable-jar[The "mutable JAR" packaging type (for remote development mode).], tooltip:legacy-jar[The "legacy JAR" packaging type. This corresponds to the packaging type used in Quarkus before version 1.12.]
|tooltip:fast-jar[The "fast JAR" packaging type.]

h|[[quarkus-core_section_quarkus-package-jar-manifest]] [.section-name.section-level1]##link:#quarkus-core_section_quarkus-package-jar-manifest[The JAR's manifest]##
h|Type
h|Default
...
h|[[quarkus-core_section_quarkus-package-jar-aot]] [.section-name.section-level1]##link:#quarkus-core_section_quarkus-package-jar-aot[AOT file sub-configuration]##
h|Type
h|Default

a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-package-jar-aot-enabled]] [.property-path]##link:#quarkus-core_quarkus-package-jar-aot-enabled[`+++quarkus.package.jar.aot.enabled+++`]##
ifdef::add-copy-button-to-config-props[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-package-jar-aot-type]] [.property-path]##link:#quarkus-core_quarkus-package-jar-aot-type[`+++quarkus.package.jar.aot.type+++`]##
ifdef::add-copy-button-to-config-props[]
...
If `auto` is used, Quarkus will generate an AOT file on OpenJDK 25{plus}, an SCC on IBM Semeru, and an AppCDS file otherwise.
...
--
a|`auto`, `aot`, `app-cds`, `scc`
|

a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-package-jar-aot-additional-recording-args]] [.property-path]##link:#quarkus-core_quarkus-package-jar-aot-additional-recording-args[`+++quarkus.package.jar.aot.additional-recording-args+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.package.jar.aot.additional-recording-args+++[]
endif::add-copy-button-to-config-props[]
...
For instance, may be used to enable advanced logging with: `-Xlog:aot{plus}map=trace,aot{plus}map{plus}oops=trace,aot=warning:file=aot-analysis.map:none:filesize=0 -Xlog:aot{plus}resolve++*++=trace,aot{plus}codecache{plus}exit=debug:file=training.log:level,tags`

If an argument includes the `,` symbol, it needs to be escaped, e.g. `++\\++,`


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_PACKAGE_JAR_AOT_ADDITIONAL_RECORDING_ARGS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-core_quarkus-package-jar-aot-phase]] [.property-path]##link:#quarkus-core_quarkus-package-jar-aot-phase[`+++quarkus.package.jar.aot.phase+++`]##
ifdef::add-copy-button-to-config-props[]
